          ...
          <section id="contact" className="contact">
            <div className="container">
              <div className="section-title">
                ...
                <p>
                  En esta seccion podras agregar los estudios que has cursado a
                  lo largo de tu carrera para que las demas personas lo vean y
                  puedan llamarte y contratarte para un proyecto que ellos
